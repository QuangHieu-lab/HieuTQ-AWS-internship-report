...
![Danh sách dịch vụ IAM](/images/4-Event/IAM.jpg)  
*Giới thiệu về các dịch vụ IAM*

![Giới thiệu Cloudclub](/images/4-Event/cloudclub.jpg)  
*Cloudclub là một câu lạc bộ thú vị để học và trải nghiệm*

![Khám phá Security trong AWS](/images/4-Event/Securityhub.jpg)  
*Tìm hiểu thêm về bảo mật AWS*

![Tìm hiểu thêm về các sự cố và đưa ra những giải pháp](/images/4-Event/incident.jpg)  
*Cơ hội gặp gỡ chuyên gia quốc tế và học hỏi kinh nghiệm*
